...
<body>
	...
	<section class="container-fluid col-lg-8 mt-5 ml-5">
		<div>
			<form action="./join.ssy" method="post">
				<div class="col-md-3">
				...
				<div class="col-3">
					...
					<input type="text" name="name"class="form-control" id="inputAddress" placeholder="zuzu">
				</div>
				<div class="col-3">
					<label for="inputAddress2" class="form-label">이메일</label>
					<input type="email" name="email" class="form-control" id="inputAddress2" placeholder="ss@naver.com">
				</div>
				<div class="col-md-3">
